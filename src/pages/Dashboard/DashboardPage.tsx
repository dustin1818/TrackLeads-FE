  ...
  return (
    <section className="space-y-5">
      <div>
        ...
        <p className="text-sm text-slate-500">Quick overview of your pipeline activity.</p>
      </div>
      ...
      <div className="grid gap-4 sm:grid-cols-2 xl:grid-cols-4">
        ...
        <Card>
          ...
          <CardContent className="text-3xl font-bold">{todos.length}</CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent className="text-3xl font-bold">{completedTodos}</CardContent>
        </Card>
